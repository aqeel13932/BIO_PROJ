...
model = Sequential()  
model.add(LSTM(1000,input_shape=(1,24),return_sequences=False))  
...
model_checkpoint = ModelCheckpoint('output_files/Model_LSTM3_{epoch:02d}-{val_loss:.2f}.h5', monitor='val_loss', verbose=0, save_best_only=True, save_weights_only=False, mode='min')
